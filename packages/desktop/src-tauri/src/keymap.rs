...
pub fn bind_for(action_id: &str) -> Option<Bind> {
    match action_id {
        ...
        "v_weapon_countermeasure_decoy_launch" => Some(Bind { key: "h", modifiers: &[], assigned: true, activation: "press" }),
        "v_weapon_countermeasure_noise_launch" => Some(Bind { key: "j", modifiers: &[], assigned: true, activation: "press" }),
        "v_weapon_countermeasure_decoy_burst_increase" => Some(Bind { key: "h", modifiers: &["ralt"], assigned: true, activation: "press" }),
        "v_weapon_countermeasure_decoy_burst_decrease" => Some(Bind { key: "h", modifiers: &["lalt"], assigned: true, activation: "press" }),
        "v_weapon_countermeasure_decoy_launch_panic" => Some(Bind { key: "f1", modifiers: &["rctrl"], assigned: true, activation: "press" }),
